            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <Link href="/menu" className="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-500">
                    Our Menu
                  </Link>
                  <Link href="/parties" className="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-500">
                    Party Packages
                  </Link>
                  <Link href="/churro-cart" className="block px-4 py-2 text-gray-700 hover:bg-orange-50 hover:text-orange-500">
                    Churro Cart
                  </Link>
                </div>
              </div>
              ...
              <Link href="/store" className="text-gray-700 hover:text-orange-500 font-medium transition-colors">
                Contact
              </Link>
            </nav>
            ...
            >
              <div className="container mx-auto px-4 py-4">
                <nav className="flex flex-col space-y-4">
                  ...
                  <Link href="/our-story" className="text-gray-700 hover:text-orange-500 font-medium">
                    About
                  </Link>
                  <div className="space-y-2">
                    <div className="text-gray-700 font-medium">Menu</div>
                    <div className="ml-4 space-y-2">
                      <Link href="/menu" className="block text-gray-600 hover:text-orange-500">
                        Our Menu
                      </Link>
                      <Link href="/parties" className="block text-gray-600 hover:text-orange-500">
                        Party Packages
                      </Link>
                      <Link href="/churro-cart" className="block text-gray-600 hover:text-orange-500">
                        Churro Cart
                      </Link>
                    </div>
                  </div>
                  <Link href="/gallery" className="text-gray-700 hover:text-orange-500 font-medium">
                    Gallery
                  </Link>
                  <Link href="/store" className="text-gray-700 hover:text-orange-500 font-medium">
                    Contact
                  </Link>
                  <div className="pt-4 border-t">
                    ...
                    <Link 
                      href="/reservation" 
                      className="block bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-full font-medium text-center transition-colors"
                    >
                      Book a Table
                    </Link>
                  </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Houston's first authentic churrería, bringing you the finest churros and chocolate with traditional Mexican recipes.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/parties" className="text-gray-300 hover:text-orange-500 transition-colors">Party Packages</Link></li>
                <li><Link href="/churro-cart" className="text-gray-300 hover:text-orange-500 transition-colors">Churro Cart</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">Subscribe to get updates on our latest churros and special offers!</p>
              <div className="flex">
                <input 
                  type="email" 
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 Angels Churros N Chocolate. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
