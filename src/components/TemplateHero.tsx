  ...
  const slides = [
    {
      ...
      description: "Fresh churros made daily with traditional recipes",
      image: "/assets/churro-hero.jpg",
      videoUrl: "https://www.youtube.com/watch?v=ySd-XWQWhbI"
    },
    {
      id: 2,
        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
          <div className="relative w-full max-w-4xl">
            ...
            <div className="aspect-video bg-black rounded-lg overflow-hidden">
              <iframe
                src="https://www.youtube.com/embed/ySd-XWQWhbI?autoplay=1"
                title="Angels Churros Video"
